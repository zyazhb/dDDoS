            ...
            return s(t, [{
                ...
                value: function(e, i, s) {
                    ...
                    if (i.total.show && a.globals.series.length > 1) {
                        new t(this.ctx).printInnerLabels(i, i.total.label, i.total.formatter(a))
                    } else {
                ...
                value: function() {
                    ...
                    return t.globals.xLabelFormatter = function(t) {
                        ...
                        void 0 !== e.labels.formatter ? t.globals.yLabelFormatters[i] = e.labels.formatter : t.globals.yLabelFormatters[i] = function(s) {
                            return d.isNumber(s) ? 0 !== t.globals.yValueDecimal ? s.toFixed(void 0 !== e.decimalsInFloat ? e.decimalsInFloat : t.globals.yValueDecimal) : t.globals.maxYArr[i] - t.globals.minYArr[i] < 5 ? s.toFixed(1) : s.toFixed(0) : s
                        }
                    }), t.globals
                }
            }, {
        ...
        N = function() {
            ...
            return s(t, [{
                ...
                value: function(t, e, i, s) {
                    ...
                    return a = new D(this.ctx).xLabelFormat(l, o), void 0 !== h && (a = h(o, t[s], s)), e.length > 0 ? (i = e[s].position, a = e[s].value) : "datetime" === r.config.xaxis.type && void 0 === h && (a = ""), void 0 === a && (a = ""), (0 === (a = a.toString()).indexOf("NaN") || 0 === a.toLowerCase().indexOf("invalid") || a.toLowerCase().indexOf("infinity") >= 0 || n.indexOf(a) >= 0 && !r.config.xaxis.labels.showDuplicates) && (a = ""), {
                        x: i,
                        text: a
                    }
                }
                ...
                value: function() {
                    ...
                    if (e.globals.timelineLabels.length > 0) {
                        ...
                        e.globals.isBarHorizontal && (r = e.globals.yAxisScale[0].result.reduce(function(t, e) {
                            return t.length > e.length ? t : e
                        }, 0)), r = new D(this.ctx).xLabelFormat(n, r);
        ...
        function() {
            ...
            return s(i, [{
                ...
                value: function(e) {
                    ...
                    this.w.globals.isExecCalled && (n = [this], this.w.globals.isExecCalled = !1), n.forEach(function(n) {
                        var r = n.w;
